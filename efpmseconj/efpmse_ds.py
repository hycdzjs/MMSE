import sys, logging
from utils.efpmseDS import MMCSEDS
# import SSEUtil
...
if __name__ == "__main__":
    ...
    ds_obj.Update('add', 13, "banana")
    ds_obj.Update('add', 14, "banana")
    ds_obj.Update('add', 15, "banana")
    # ds_obj.Update('add', 6, "banana")
    # ds_obj.Update('add', 7, "banana")
    # ds_obj.Update('del', 4, "banana")
    
    ds_obj.Update('add', 2, "pincode")
